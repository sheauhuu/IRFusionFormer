...
class ConfusionMatrix:
    ...
    def compute(self):
        ...
        # self.test_empty = not self.test.any()
...
def fscore(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=False, beta=1., **kwargs):
    ...
    return (1 + beta*beta) * precision_ * recall_ /\
        ((beta*beta * precision_) + recall_+1e-5)
...
def hausdorff_distance_95(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=False, voxel_spacing=None, connectivity=1, **kwargs):
...
def avg_surface_distance(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=False, voxel_spacing=None, connectivity=1, **kwargs):
...
def avg_surface_distance_symmetric(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=False, voxel_spacing=None, connectivity=1, **kwargs):
